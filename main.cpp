#include <iostream>
using namespace std;
/*–озрахувати п≥дсумкову варт≥сть покупки, перв≥сну варт≥сть запросити у користувача.
якщо варт≥сть покупки б≥льша за 1000 грн, але менша за 2000грн, знижка 5%, €кщо б≥льше за 2000 грн, але менша за 5000 грн, знижка 10%.
*/
int main() {
